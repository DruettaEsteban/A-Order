...
public class FrameMP extends Application{
    ...
    public void start(Stage primaryStage) {
        ...
        options.forEach(option -> option.setStyle("-fx-padding: "+ ANSWER_HEIGHT + " " + ANSWER_WIDTH + " " + ANSWER_HEIGHT + " "+ ANSWER_WIDTH+"; -fx-border-color: black;  -fx-border-width: 2; -fx-border-style: solid inside; -fx-border-radius: 50;"));
        ...
        question.setStyle("-fx-padding: "+ QUESTION_HEIGHT + " " + QUESTION_WIDTH + " " + QUESTION_HEIGHT + " "+ QUESTION_WIDTH+"; -fx-border-color: black;  -fx-border-width: 2; -fx-border-style: solid inside; -fx-border-radius: 50;");
    ...
    private void turnRed(Answers answer){
        ...
        Thread turnRed = new Thread(() -> {
            try {
                Thread.sleep(duration);
                options.get(answer.getAnswer()).setStyle("-fx-background-color: red; -fx-background-radius: 50 50 50 50;"+"-fx-padding: "+ ANSWER_HEIGHT + " " + ANSWER_WIDTH + " " + ANSWER_HEIGHT + " "+ ANSWER_WIDTH+"; -fx-border-color: black;  -fx-border-width: 2; -fx-border-style: solid inside; -fx-border-radius: 50;");
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        });
    ...
    public void evaluateAndDisplay(Answers userResponse){
        if(canEvaluate()){
            ...
            options.get(correct.getAnswer()).setStyle("-fx-padding: "+ ANSWER_HEIGHT + " " + ANSWER_WIDTH + " " + ANSWER_HEIGHT + " "+ ANSWER_WIDTH+"; -fx-border-color: yellow;  -fx-border-width: 8; -fx-border-style: solid inside; -fx-border-radius: 50;");
