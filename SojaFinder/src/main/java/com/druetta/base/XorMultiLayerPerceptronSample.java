...
public class XorMultiLayerPerceptronSample implements LearningEventListener {
    ...
    public void run() {
        ...
        MultiLayerPerceptron myMlPerceptron = new MultiLayerPerceptron(TransferFunctionType.SIGMOID, 2, 3, 3, 1);
        ...
        myMlPerceptron.getLearningRule().setMaxIterations(1000000);
